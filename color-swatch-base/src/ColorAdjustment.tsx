...
export interface AjustmentInputProps {
  id: string;
  label:string;
  value:number;
...
export interface ColorAdjustmentProps {
  Adjustment: React.ComponentType<AjustmentInputProps>
}
...
export const ColorAdjustment = ({Adjustment}: ColorAdjustmentProps) => {
  ...
  return (
    <section className="color-sliders">
      ...
      <Adjustment id="green-slider" label="Green" value={green} onChange={adjustGreen} />
      <Adjustment id="blue-slider" label="Blue" value={blue}  onChange={adjustBlue}/>
    </section>
  );
};